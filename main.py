...
async def search_and_forward(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if is_author_request and author_query:
        ...
        phrases_to_remove = sorted([
            "اريد كتاب", "أريد كتاب","ابغى","ابغى كتاب","ابغى رواية", "ممكن","ممكن كتاب","ممكن رواية","الاقي","الاقي كتاب","الاقي رواية","عايزة","عايزة كتاب","عايزة رواية","عايز","عايز كتاب","عايز رواية","عاوزة","عاوزة كتاب","عاوزة رواية","عاوز","عاوز كتاب","عاوز رواية", "اريد كتاب ال", "أريد كتاب ال",
